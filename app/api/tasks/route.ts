...
export async function POST(req: NextRequest) {
  ...
  const { title, description, deadline, priority, categoryId, goalId, estimatedMinutes, recurrence, recurrenceEnd, subtasks, intentionWhen, intentionWhere, isUrgent, isImportant, energyLevel } = parsed.data;
