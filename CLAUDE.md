...
| AI (opcjonalne) | Anthropic Claude API (`claude-sonnet-4-6`) |
...
└── api/
    ...
    └── ai/prioritize/route.ts      ← POST (Claude AI priorytetyzacja)
...
├── claude.ts                   ← prioritizeTasks() via Anthropic SDK
